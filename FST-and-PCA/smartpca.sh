...
snps=/scratch/user/edegreef/reseq/filter_scaffolds/imputed.qualityfiltered.ZWout.pop.recode.vcf
population=list_4pop_colony
samples=list_4pop_indiv
output="PUMApops_auto"
version="run1_auto"
